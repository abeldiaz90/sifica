...
namespace SISGRES
{
    public partial class GenerarRequisicionesHerramientas : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            try
            {
                if (Double.Parse(this.txtCantidad.Text) > 0)
                {
                    ...
                    db.REQUISICION_HERRAMIENTAS_NUEVA_REQUISICION(this.txtItem.Text, float.Parse(this.txtCantidad.Text), this.User.Identity.Name.ToString());
                    db.SubmitChanges();

                    //if (Session["TablaDatos"] == null)
                    //{
                    //    DataTable TablaHerramientas = new DataTable();
                    ...
                    //    TablaHerramientas.Columns.Add(column);
                    //    TablaHerramientas.Columns.Add("ID_HERRAMIENTA", typeof(string));
                    //    TablaHerramientas.Columns.Add("HERRAMIENTA", typeof(string));
                    //    TablaHerramientas.Columns.Add("UNIDAD", typeof(string));
                    //    TablaHerramientas.Columns.Add("CANTIDAD", typeof(string));

                    //    DataRow row = TablaHerramientas.NewRow();
                    //    SIFICADataContext db = new SIFICADataContext();
                    //    var query = db.HERRAMIENTAS_BUSCAR_ELEMENTOS_POR_DESCRIPCION(this.txtItem.Text);


                    //    foreach (var q in query)
                    //    {
                    //        //row["ID_PARTIDA"] = q.ID_MATERIAL;
                    //        row["ID_HERRAMIENTA"] = q.ID_HERRAMIENTA;
                    //        row["HERRAMIENTA"] = q.HERRAMIENTA;
                    //        row["UNIDAD"] = q.UNIDAD;
                    ...
                    //    TablaHerramientas.Rows.Add(row);
                    //    Session["TablaDatos"] = TablaHerramientas;


                    //}
                    //else
                    //{
                    //    DataTable TablaHerramientas = (DataTable)Session["TablaDatos"];
                    ...
                    //    foreach (var q in query)
                    //    {
                    //        DataRow[] Valida = TablaHerramientas.Select("ID_HERRAMIENTA=" + q.ID_HERRAMIENTA);
                    //        if (Valida.Length >= 1)
                    //        {
                    ...
                    //    }
                    //}
                    this.ASPxGridView1.DataSource = db.REQUISICION_HERRAMIENTAS_CONSULTAR_USUARIO(this.User.Identity.Name.ToString());
        ...
        protected void ASPxButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                SIFICADataContext db = new SIFICADataContext();
                db.REQUISICIONES_HERRAMIENTAS_INSERTAR(this.User.Identity.Name.ToString(), this.cboProyectos.Text, this.txtLugarEntrega.Text, this.FechaEntrega.Date);
                db.SubmitChanges();

                var query = db.REQUISICIONES_HERRAMIENTAS_OBTENER_ID(this.User.Identity.Name.ToString());
                Int32 Id = 0;
                ...
                {
                    db.REQUISICIONES_HERRAMIENTAS_DETALLES_INSERTAR(Id, Int32.Parse(this.ASPxGridView1.GetRowValues(i, "ID_HERRAMIENTA").ToString()), Decimal.Parse(this.ASPxGridView1.GetRowValues(i, "CANTIDAD").ToString()));
                    db.SubmitChanges();
                }
                ...
                SIFICADataContext DB = new SIFICADataContext();
                DB.REQUISICIONES_LIMPIAR_PARTIDAS_HERRAMIENTAS(this.User.Identity.Name.ToString());
                DB.SubmitChanges();
        ...
        public void EnviarCorreo(Int32 Nivel)
        {
            SIFICADataContext db = new SIFICADataContext();
            var query = db.REQUISICIONES_HERRAMIENTAS_OBTENER_ID(this.User.Identity.Name.ToString());
            Int32 Id = 0;
            ...
            String Cuerpo = "LA REQUISICION DE HERRAMIENTAS CON NUMERO DE FOLIO: " + Id.ToString() + " HA SIDO GENERADA POR: " + NombreDeUsuario + " <p>SE ENVIA PARA SU REVISION Y APROBACION. <a href='http://sifica-001-site1.smarterasp.net/AprobacionesRequisicionesHerramientas.aspx'> HAGA CLICK PARA INGRESAR AL MODULO DE COMPRAS PARA REALIZAR LA APROBACION </a>";
            Cuerpo = Cuerpo + "<html><p><table border='1' align='center'><TR><TD align='center'>PARTIDA</TD><TD align='center'>CLAVE DE LA HERRAMIENTA</TD><TD align='center'>DESCRIPCIÓN</TD><TD align='center'>UNIDAD DE MEDIDA</TD><TD align='center'>CANTIDAD</TD></TR>";

            for (int i = 0; i <= this.ASPxGridView1.VisibleRowCount - 1; i++)
            {
                Cuerpo = Cuerpo + "<TR><TD align='center'>" + this.ASPxGridView1.GetRowValues(i, "ID_PARTIDA").ToString() + "</TD><TD align='center'>" + this.ASPxGridView1.GetRowValues(i, "ID_HERRAMIENTA").ToString() + "</TD><TD align='center'>" + this.ASPxGridView1.GetRowValues(i, "HERRAMIENTA").ToString() + "</TD><TD align='center'>" + this.ASPxGridView1.GetRowValues(i, "UNIDAD").ToString() + "</TD><TD align='center'>" + this.ASPxGridView1.GetRowValues(i, "CANTIDAD").ToString() + "</TD></TR>";
            }
        ...
        protected void lnkModificar_Click(object sender, EventArgs e)
        {
            try
            {
                this.txtItem.Text = string.Empty;
                this.txtCantidad.Text = string.Empty;
                this.txtItem.Text = this.ASPxGridView1.GetRowValues(this.ASPxGridView1.FocusedRowIndex, "HERRAMIENTA").ToString();
        ...
        protected void lnkEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                SIFICADataContext db = new SIFICADataContext();
                db.REQUISICION_HERRAMIENTAS_ELIMINA_PARTIDAS(Int32.Parse(this.ASPxGridView1.GetRowValues(this.ASPxGridView1.FocusedRowIndex, "ID_PARTIDA").ToString()));
                db.SubmitChanges();
        ...
        protected void imgGuardar_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (Double.Parse(this.txtCantidad.Text) > 0)
                {
                    ...
                    SIFICADataContext DB = new SIFICADataContext();
                    DB.REQUISICIONES_HERRAMIENTAS_ACTUALIZA_PARTIDAS(Int32.Parse(this.ASPxGridView1.GetRowValues(this.ASPxGridView1.FocusedRowIndex, "ID_PARTIDA").ToString()), this.txtItem.Text, float.Parse(this.txtCantidad.Text));
                    DB.SubmitChanges();
                    ...
                    //customerRow[0]["HERRAMIENTA"] = this.txtItem.Text;
        ...
        protected void lnkDetalle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                report.ReportPath = "RequisicionHerramientas.rdlc";

                DataTable ds = DatosRequisicionHerramientas();
                DataTable dslogo = ObtenerLogoEmpresa();
                
                ReportDataSource dsMain = new ReportDataSource();
                dsMain.Name = "RequisicionHerramientas";
                dsMain.Value = ds;
                ...
                this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("RequisicionHerramientas.rdlc");
        ...
        public DataTable DatosRequisicionHerramientas()
        {
            ...
            try
            {
                ...
                com.Connection = con;
                com.CommandType = CommandType.StoredProcedure;
                com.CommandText = "REQUISICIONES_HERRAMIENTAS_MOSTRAR_A_DETALLE_USUARIO";
        ...
        protected void ASPxMenu2_ItemClick(object source, DevExpress.Web.MenuItemEventArgs e)
        {
            ...
            {
                SIFICADataContext db = new SIFICADataContext();
                this.grdAprobaciones.DataSource = db.REQUISICIONES_HERRAMIENTAS_MOSTRAR_POR_USUARIO(this.User.Identity.Name.ToString());
