...
namespace SISGRES
{
    public partial class AprobacionOrdenesCompraHerramientas : System.Web.UI.Page
    {
        ...
        public DataTable DatosRequisicionHerramientas()
        {
            ...
            try
            {
                ...
                com.CommandText = "ORDENES_COMPRA_HERRAMIENTAS_VER_DETALLE_PROOVEDOR_REQUISICION_FOLIO_A";
        ...
        public DataTable DatosRequisicionHerramientasFolioB()
        {
            DataTable Requsicion = new DataTable();
            try
            {
                ...
                com.Connection = con;
                com.CommandType = CommandType.StoredProcedure;
                com.CommandText = "ORDENES_COMPRA_HERRAMIENTAS_VER_DETALLE_PROOVEDOR_REQUISICION";
                com.Parameters.AddWithValue("@ID_REQUISICION", this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString());
                com.Parameters.AddWithValue("@ID_PROOVEDOR", this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_PROOVEDOR").ToString());
                com.CommandTimeout = 0;
                com.ExecuteNonQuery();
        ...
        public void EnviarCorreo(String ID_REQUISICION, String ID_COMPRA)
        {
            ...
            report.ReportPath = "OrdenCompraHerramientas.rdlc";
            ...
            if (this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "FOLIO").ToString() == "A")
            {
                ...
                ds = DatosRequisicionHerramientas();
            ...
            else if (this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "FOLIO").ToString() == "B")
            {
                ...
                ds = DatosRequisicionHerramientasFolioB();
            ...
            msg.Body = "LA ORDEN DE COMPRA DE HERRAMIENTAS CON NUMERO DE FOLIO:  " + ID_COMPRA + " HA SIDO APROBADA POR:  " + NombreDeUsuarioQueEstaAprobando + "<p>COMENTARIOS : " + this.txtComentarios.Text;
        ...
        public void EnviarCorreoRetorno(String ID_REQUISICION, String ID_COMPRA)
        {
            ...
            String UsuarioCreador = "";
            String CorreoElectronicoUsuarioCreador = "";
            var DatosCreador = db.REQUISICIONES_HERRAMIENTAS_OBTENER_NOMBRE_CREADOR(Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString()));
            foreach (var NombreCrea in DatosCreador)
            {
                UsuarioCreador = NombreCrea.NOMBRE;
                CorreoElectronicoUsuarioCreador = NombreCrea.CORREO_ELECTRONICO;
            ...
            msg.CC.Add(FormatMultipleEmailAddresses(UsuariosConCopia));
            msg.SubjectEncoding = System.Text.Encoding.UTF8;
            msg.Body = "LA ORDEN DE COMPRA DE HERRAMIENTAS CON NUMERO DE FOLIO:  " + ID_COMPRA + " HA SIDO RETORNADA POR:  " + NombreDeUsuarioQueEstaAprobando + "<p>COMENTARIOS : " + this.txtComentarios.Text;
            msg.BodyEncoding = System.Text.Encoding.UTF8;
            //msg.Attachments.Add(data);
            msg.IsBodyHtml = true;
        ...
        public void EnviarCorreoCancela(String ID_REQUISICION, String ID_COMPRA)
        {
            ...
            msg.CC.Add(FormatMultipleEmailAddresses(UsuariosConCopia));
            msg.SubjectEncoding = System.Text.Encoding.UTF8;
            msg.Body = "LA ORDEN DE COMPRA DE HERRAMIENTAS CON NUMERO DE FOLIO:  " + ID_COMPRA + " HA SIDO CANCELADA POR:  " + NombreDeUsuarioQueEstaAprobando + "<p>COMENTARIOS : " + this.txtComentarios.Text;
            msg.BodyEncoding = System.Text.Encoding.UTF8;
            //msg.Attachments.Add(data);
            msg.IsBodyHtml = true;
        ...
        public void ReporteFolioB()
        {
            try
            {
                ...
                LocalReport report = new LocalReport();
                report.EnableExternalImages = true;
                report.ReportPath = "OrdenCompraHerramientasFolioB.rdlc";

                DataTable ds = DatosRequisicionHerramientasFolioB();
                DataTable dslogo = ObtenerLogoEmpresa();
                DataTable dsFirma = ObtenerFirmaAprobadorCompra();
                ...
                this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("OrdenCompraHerramientasFolioB.rdlc");
        ...
        public void ReporteFolioA()
        {
            try
            {
                ...
                ReportDataSource dsMain = new ReportDataSource();
                dsMain.Name = "DetallesOrdenesCompraHerramientas";
                dsMain.Value = ds;
                ...
                ReportParameter p1 = new ReportParameter("Letras", enletras(ds.Rows[0]["TOTAL"].ToString()));
                this.ReportViewer1.Visible = true;
                this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("OrdenCompraHerramientas.rdlc");
                this.ReportViewer1.LocalReport.DataSources.Clear();
                this.ReportViewer1.LocalReport.DataSources.Add(dsMain);
                this.ReportViewer1.LocalReport.DataSources.Add(logo);
                this.ReportViewer1.LocalReport.DataSources.Add(Firma);
        ...
        public string enletras(string num)
        {
            ...
            if (ds.Rows[0]["MONEDA"].ToString() == "MXN")
            {
                ...
                else { dec = " PESOS " + decimales.ToString() + "/100 M.N."; }
            }
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "FOLIO").ToString() == "A")
                {
                    ...
                    {
                        SIFICADataContext DB = new SIFICADataContext();
                        DB.RETORNAR_ORDEN_COMPRA_HERRAMIENTAS_FOLIO_A(Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString()), Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_PROOVEDOR").ToString()), this.User.Identity.Name.ToString(), this.txtComentarios.Text, Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_ORDEN_COMPRA").ToString()));
                        DB.SubmitChanges();
                    ...
                    {
                        SIFICADataContext DB = new SIFICADataContext();
                        DB.CANCELAR_ORDEN_COMPRA_HERRAMIENTAS_FOLIO_A(Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString()), Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_ORDEN_COMPRA").ToString()));
                        DB.SubmitChanges();
                ...
                else if (this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "FOLIO").ToString() == "B")
                {
                    ...
                    {
                        SIFICADataContext DB = new SIFICADataContext();
                        DB.APROBAR_ORDEN_COMPRA_HERRAMIENTAS(Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString()), Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_PROOVEDOR").ToString()), this.User.Identity.Name.ToString(), this.txtComentarios.Text, Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_ORDEN_COMPRA").ToString()));
                        DB.SubmitChanges();
                    ...
                    {
                        SIFICADataContext DB = new SIFICADataContext();
                        DB.RETORNAR_ORDEN_COMPRA_HERRAMIENTAS(Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString()), Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_PROOVEDOR").ToString()), this.User.Identity.Name.ToString(), this.txtComentarios.Text, Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_ORDEN_COMPRA").ToString()));
                        DB.SubmitChanges();
                        EnviarCorreoRetorno(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString(), this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_ORDEN_COMPRA").ToString());
                        this.popupDetalle.ShowOnPageLoad = false;
                        this.popupComentarios.ShowOnPageLoad = false;
                    ...
                    {
                        SIFICADataContext DB = new SIFICADataContext();
                        DB.CANCELAR_ORDEN_COMPRA_HERRAMIENTAS(Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString()), Int32.Parse(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_ORDEN_COMPRA").ToString()));
                        DB.SubmitChanges();
                        EnviarCorreoCancela(this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_REQUISICION").ToString(), this.grdAprobaciones.GetRowValues(this.grdAprobaciones.FocusedRowIndex, "ID_ORDEN_COMPRA").ToString());
                        this.popupDetalle.ShowOnPageLoad = false;
                        this.popupComentarios.ShowOnPageLoad = false;
