	...
	SELECT ID_PROYECTO,PROYECTO FROM PROYECTOS WHERE ID_COMPAÑIA=@ID_COMPAÑIA">
                                        ...
                                        <tr>
                                            <td align="justify" width="150px">
                                                <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="OBSERVACIONES:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td align="left" colspan="3">
                                                <dx:ASPxMemo ID="txtObservaciones" runat="server" Height="71px" ReadOnly="True" Theme="Office2003Olive" Width="70%">
                                                    <ReadOnlyStyle BackColor="#CCCCCC">
                                                    </ReadOnlyStyle>
                                                </dx:ASPxMemo>
                                            </td>
