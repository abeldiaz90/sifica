...
namespace SISGRES
{
    public partial class Requisiciones : System.Web.UI.Page
    {
        ...
        protected void grdHerramientas_HtmlDataCellPrepared(object sender, DevExpress.Web.ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            {
                ASPxTextBox textBox = grdHerramientas.FindRowCellTemplateControl(e.VisibleIndex, e.DataColumn, "txtCantidad") as ASPxTextBox;
        ...
        protected void btnEnviarAprobación_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.REQUISICIONES_HERRAMIENTAS_INSERTAR(this.User.Identity.Name.ToString(), this.txtJustificacion.Text,"",null);
                db.SubmitChanges();
                ...
                grdHerramientas.FilterExpression = string.Empty;
                for (int i = 0; i <= this.grdHerramientas.VisibleRowCount - 1; i++)
                {
                    DevExpress.Web.ASPxTextBox txtCantidad = ((DevExpress.Web.ASPxTextBox)grdHerramientas.FindRowCellTemplateControl(i, grdHerramientas.Columns["Cantidad"] as DevExpress.Web.GridViewDataTextColumn, "txtCantidad"));
                    if (!String.IsNullOrEmpty(txtCantidad.Text))
                    {
                        db.REQUISICIONES_HERRAMIENTAS_DETALLES_INSERTAR(Id, Int32.Parse(this.grdHerramientas.GetRowValues(i, "ID_HERRAMIENTA").ToString()), Int32.Parse(txtCantidad.Text));
                        db.SubmitChanges();
        ...
        protected void btnVisualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                report.ReportPath = "VistaPreviaRequisicionHerramientas.rdlc";
                ...
                this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("VistaPreviaRequisicionHerramientas.rdlc");
        ...
        public DataTable TablaCantidades()
        {
            ...
            for (int i = 0; i <= this.grdHerramientas.VisibleRowCount - 1; i++)
            {
                ...
                if (!String.IsNullOrEmpty(txtCantidad.Text))
                {
                    ...
                    _ravi["ID_MATERIAL"] = Unidad(this.grdHerramientas.GetRowValues(i, "ID_UNIDAD").ToString());
                    _ravi["CANTIDAD"] = this.grdHerramientas.GetRowValues(i, "HERRAMIENTA").ToString();
