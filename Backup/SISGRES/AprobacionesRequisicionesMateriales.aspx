<%@ Page Title="APROBACIÓN DE REQUISICIONES DE MATERIALES" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="AprobacionesRequisicionesMateriales.aspx.cs" Inherits="SISGRES.AprobacionesRequisicionesMateriales" EnableEventValidation="true" %>
...
<dx:PopupControlContentControl runat="server">
        ...
        <tr>
            <td align="center">
                <dx:ASPxButton ID="ASPxButton2" runat="server" HorizontalAlign="Center" 
                    OnClick="ASPxButton2_Click" Text="Aprobar" Theme="Youthful">
                    <ClientSideEvents Click="function(s, e) {
    ...
    <asp:SqlDataSource ID="AprobacionesRequisicionesHerramientasDatos" 
        ...
        SelectCommand="REQUISICIONES_MATERIALES_MOSTRAR_TODAS" 
    ...
    <dx:ASPxPopupControl ID="popupReporte" runat="server" 
        ...
        Theme="Youthful" Width="700px" AllowDragging="True" AllowResize="True" 
...
<dx:PopupControlContentControl runat="server">
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        DocumentMapCollapsed="True" DocumentMapWidth="100%" PromptAreaCollapsed="True" 
        SizeToReportContent="True" ShowPrintButton="True" ZoomMode="PageWidth" 
        Height="700px">
        <LocalReport EnableExternalImages="True" EnableHyperlinks="True" 
            ReportPath="RequisicionMateriales.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                    Name="RequisicionesMaterialesDetalle" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        SelectMethod="GetData" 
        TypeName="SIFICA.RequisicionesMaterialesDetalleTableAdapters.REQUISICIONES_MATERIALES_MOSTRAR_A_DETALLETableAdapter">
