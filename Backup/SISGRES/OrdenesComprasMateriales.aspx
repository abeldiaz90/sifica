<%@ Page Title="Ordenes de Compra de Materiales" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="OrdenesComprasMateriales.aspx.cs" Inherits="SISGRES.OrdenesComprasMateriales" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <dx:ASPxGridView ID="grdAprobaciones" runat="server" 
        ...
        KeyFieldName="ID_REQUISICION" Theme="BlackGlass" Width="100%" 
    ...
    <dx:ASPxPopupControl ID="popupDetalle" runat="server" 
        ...
        Theme="BlackGlass" Width="1200px" AllowDragging="True" AllowResize="True" 
        Modal="True" ShowPageScrollbarWhenModal="True" ShowPinButton="True" 
    ShowRefreshButton="True" CloseAction="CloseButton">
...
<dx:PopupControlContentControl runat="server">
        ...
        <tr>
            ...
            <td colspan="4">
                <dx:ASPxButton ID="ASPxButton2" runat="server" AutoPostBack="False" 
                    EnableTheming="True" OnClick="ASPxButton2_Click2" 
            ...
            <td align="center" valign="top">
                ...
                <dx:ASPxComboBox ID="cboAplicaIVA" runat="server" HorizontalAlign="Center" 
                    ...
                    <Items>
                        ...
                        <dx:ListEditItem Text="NO" Value="0.0" />
                    </Items>
                    <ValidationSettings ErrorTextPosition="Bottom" SetFocusOnError="True" 
                        ValidationGroup="OrdenCompra">
                        <RequiredField IsRequired="True" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <dx:ASPxGridView ID="grdDetallesOrdenes" runat="server" 
                AutoGenerateColumns="False" ClientInstanceName="grdDetallesOrdenes" 
                DataSourceID="DetallesOrdenesCompras" EnableTheming="True" 
	...
	grdProvedoresCotizaciones.Refresh();
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="MATERIAL" VisibleIndex="5">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="PRECIO UNITARIO" 
                        FieldName="PRECIO_UNITARIO" VisibleIndex="6">
                        <propertiestextedit displayformatstring="c2">
                            <validationsettings errortextposition="Bottom" setfocusonerror="True">
                                <requiredfield errortext="Capture el Precio Unitario" isrequired="True" />
                            </validationsettings>
                        </propertiestextedit>
                    </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataComboBoxColumn Caption="PROVEEDOR" FieldName="ID_PROOVEDOR" 
                        VisibleIndex="9">
                        <propertiescombobox datasourceid="Proveedores" displayformatineditmode="True" 
                            incrementalfilteringmode="Contains" textfield="PROOVEDOR" 
                            valuefield="ID_PROOVEDOR">
                            <validationsettings errortext="Seleccione el Proveedor" setfocusonerror="True">
            ...
            <asp:SqlDataSource ID="DetallesOrdenesCompras" runat="server" 
                ConnectionString="<%$ ConnectionStrings:SIFICA %>" 
                SelectCommand="ORDEN_DE_COMPRA_A_DETALLE_MATERIALES" 
                SelectCommandType="StoredProcedure" 
                UpdateCommand="ORDEN_DE_COMPRA_MATERIALES_ACTUALIZAR_PRECIOS_UNITARIOS" 
                UpdateCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:SessionParameter Name="ID_REQUISICION" SessionField="ID_REQUISICION" 
                        Type="Int32" />
                </SelectParameters>
                <UpdateParameters>
            ...
            <dx:ASPxGridView ID="grdProvedoresCotizaciones" runat="server" 
                AutoGenerateColumns="False" ClientInstanceName="grdProvedoresCotizaciones" 
                DataSourceID="DocumentosCotizacionesProvedoresMateriales" EnableTheming="True" 
                KeyFieldName="ID_REQUISICION" Theme="BlackGlass" Width="100%">
                <Columns>
                    <dx:GridViewCommandColumn ShowDeleteButton="True" ShowEditButton="True" 
                        ShowNewButtonInHeader="True" VisibleIndex="0">
                    </dx:GridViewCommandColumn>
                    <dx:GridViewDataTextColumn FieldName="ID_REQUISICION" Visible="False" 
                        VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
	...
	popupCarga.Show();
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="DOCUMENTO" FieldName="DOCUMENTO" 
                        VisibleIndex="5">
            ...
            <asp:SqlDataSource ID="DocumentosCotizacionesProvedoresMateriales" 
                runat="server" ConnectionString="<%$ ConnectionStrings:SIFICA %>" 
                SelectCommand="PROOVEDORES_MOSTRAR_ORDEN_COMPRA" 
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:SessionParameter Name="ID_REQUISICION" SessionField="ID_REQUISICION" 
                        Type="Int32" />
            ...
            <dx:ASPxPopupControl ID="popupCarga" runat="server" 
                ClientInstanceName="popupCarga" HeaderText="" 
