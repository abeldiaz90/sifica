...
namespace SISGRES
{
    public partial class CuadroComparativoHerramientas : System.Web.UI.Page
    {
        ...
        protected void grdRequisicionesPartidas_DetailRowExpandedChanged(object sender, DevExpress.Web.ASPxGridViewDetailRowEventArgs e)
        {
            try
            {
        ...
        protected void btnComparativo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsMain.Name = "ComparativoHerramientas";
                dsMain.Value = ds;
                ...
                this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("ComparativoPreciosHerramientas.rdlc");
        ...
        public DataTable DatosRequisicionHerramientas()
        {
            ...
            try
            {
                ...
                com.Connection = con;
                com.CommandType = CommandType.StoredProcedure;
                com.CommandText = "REPORTE_COMAPARTIVO_HERRAMIENTAS";
